...
/**
 * 【请填写功能名称】业务对象 L_couple_anniversaries
 *
 * @author Lion Li
 * @date 2026-01-19
 */
...
@AutoMapper(target = LCoupleAnniversaries.class, reverseConvertGenerate = false)
public class LCoupleAnniversariesBo extends BaseEntity {
     ...
     * 情侣关系ID
     */
    @NotNull(message = "情侣关系ID不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     */
    @NotBlank(message = "纪念日类型 first_meet:初次见面 first_date:第一次约会 relationship_start:恋爱开始 engagement:订婚 marriage:结婚 move_in:同居 pet_adoption:共同领养宠物 other:其他不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 是否每年重复
     */
    @NotNull(message = "是否每年重复不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     */
    @NotNull(message = "重要程度 1:一般 2:重要 3:非常重要 4:特别重要 5:最重要不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * 庆祝次数
     */
    @NotNull(message = "庆祝次数不能为空", groups = { AddGroup.class, EditGroup.class })
